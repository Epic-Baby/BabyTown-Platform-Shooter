...
const ThirtyCaliber = preload("res://Weapons//Bullets//30Caliber.tscn")
...
func _process(_delta):
	...
	if Input.is_action_pressed("Click") and ShootEnable and Loaded and Cycled:
		$Sprite/Position2D.set("rotation_degrees",Random.randf_range(-0.5, 0.5))
		$Sprite/CPUParticles2D.set("emitting",true)
		var b = ThirtyCaliber.instance()
